...
class TelaCategoria4 extends StatefulWidget {
  const TelaCategoria4({super.key});

  @override
  State<TelaCategoria4> createState() => _TelaCategoria4State();
}
List<Games> category = [];
class _TelaCategoria4State extends State<TelaCategoria4> {
  @override
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i < tabela.length; i++) {
      if(tabela[i].categoria == 'Estratégia'){
